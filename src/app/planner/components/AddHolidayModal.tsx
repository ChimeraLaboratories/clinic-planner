        ...
        <>
            ...
            {!open ? null : (
                <div className="fixed inset-0 z-50">
                    <div className="absolute inset-0 bg-black/30" onClick={() => !holidayBusy && onClose()} />
                            ...
                            <div className="grid grid-cols-1 gap-2" ref={pickerRef}>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="h-10 w-full rounded-lg border border-slate-200 px-3 pr-10 text-sm"
                                                    ...
                                                    filteredClinicians.map((c) => (
                                                        ...
                                                        >
                                                            ...
                                                            {String(c.id) === holidayClinicianId && (
                                                                <span className="ml-3 text-emerald-600 font-semibold">✓</span>
                                                            )}
                                                        </button>
                                                    ))
                                                )}
